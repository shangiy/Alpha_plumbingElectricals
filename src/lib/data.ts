...
export const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'KS1010 4-Way Concealed brass Shower Mixer - Shower & Tap', price: 11640, images: ['https://picsum.photos/seed/shower-mixer/400/400'], description: 'A 4-way concealed brass shower mixer.', longDescription: 'The KS1010 is a 4-way concealed brass shower mixer, combining both shower and tap functions in one elegant, space-saving unit.', category: 'plumbing', rating: 4.9, reviews: 60, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '2186484', isFeatured: false, unit: 'item' },
