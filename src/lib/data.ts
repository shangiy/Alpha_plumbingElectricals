...
export const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'Top Tank 1500L', price: 4500, images: ['/top tank 1500L.png'], description: 'A compact 1500L Top Tank.', longDescription: 'A compact 1500L Top Tank, suitable for smaller households. Made with durable, high-quality plastic.', category: 'tanks', rating: 4.6, reviews: 28, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, unit: 'item' },
  { name: 'Tank 2000L', price: 5000, images: ['/top tank.png'], description: 'A standard 2000L Top Tank.', longDescription: 'A standard 2000L Top Tank offering great value and reliability for your water storage requirements.', category: 'tanks', rating: 4.7, reviews: 35, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, unit: 'item' },
