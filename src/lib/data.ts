...
export const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'KS1010 4-Way Concealed brass Shower Mixer - Shower & Tap', price: 11640, images: ['/KS1010 – 4 Way Concealed Brass Shower Mixer – Shower & Tap 2.png', '/KS1010 – 4 Way Concealed Brass Shower Mixer – Shower & Tap 3.png'], description: 'A 4-way concealed brass shower mixer.', longDescription: 'The KS1010 is a 4-way concealed brass shower mixer, combining both shower and tap functions in one elegant, space-saving unit.', category: 'lighting-electrical', rating: 4.9, reviews: 60, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '2186484', isFeatured: false, unit: 'item' },
  { name: '4.0mm Masai Flex Cable', price: 360, images: ['/masai-flex-cable.png'], description: 'A flexible 4.0mm electrical cable from Masai.', longDescription: 'High-quality and flexible 4.0mm electrical flex cable from Masai. Ideal for a variety of wiring applications. Price is per meter.', category: 'lighting-electrical', rating: 4.8, reviews: 210, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '16248', isFeatured: false, unit: 'meter' },
];
