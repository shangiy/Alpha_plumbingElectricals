...
export const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'Lamp Assorted Chandelier MarbleMark', price: 4800, images: ['/Lamp Assorted Chandelier MarbleMark.png'], description: 'A stylish chandelier with assorted marble-marked lamps.', longDescription: 'This beautiful chandelier features an assortment of lamps with a unique MarbleMark finish, creating a sophisticated and modern centerpiece for any room.', category: 'lighting-electrical', rating: 4.7, reviews: 25, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, unit: 'item' },
