...
export const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'IFLUX WATER HEATER SWITCH Minimalist WHITE 45A', price: 600, images: ['/IFLUXsocket.png'], description: 'A minimalist 45A water heater switch from IFLUX.', longDescription: 'A high-quality and reliable 45A water heater switch from IFLUX, featuring a clean, minimalist white design that blends seamlessly into modern interiors.', category: 'lighting-electrical', rating: 4.9, reviews: 180, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '16248', isFeatured: false, unit: 'item' },
