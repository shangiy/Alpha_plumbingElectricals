...
export const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'Ironsheet Mabati', price: 1200, images: ['/Ironsheet_Mabati.jpg', '/Roof ridges.png', '/Roofing Nails.png'], description: 'Durable ironsheet mabati for roofing.', longDescription: 'High-quality, galvanized ironsheet mabati designed to withstand harsh weather conditions. Available per meter.', category: 'roofing', rating: 4.8, reviews: 150, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, unit: 'meter' },
