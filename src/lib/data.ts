...
const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'Whole complete sink and cabinet', price: 7000, images: ['/Whole complete sink and cabinet.png'], description: 'A complete sink and cabinet set.', longDescription: 'A complete sink and cabinet set, ready to install. Provides ample storage and a sleek look.', category: 'plumbing', rating: 4.7, reviews: 18, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, colors: ['White', 'Black'], isFeatured: true },
  { name: 'Solar Heater non-pressurized', price: 12000, images: ['/Solar Heater non-pressurized.png'], description: 'An energy-efficient solar water heater.', longDescription: 'An energy-efficient non-pressurized solar water heater, perfect for reducing your electricity bills.', category: 'plumbing', rating: 4.9, reviews: 32, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, colors: ['Silver'], isFeatured: true },
  { name: 'Artistic Lights', price: 3300, images: ['/Artistic Lights.png'], description: 'Unique and stylish artistic lights.', longDescription: 'A collection of unique and stylish artistic lights to make a statement in any room.', category: 'lighting-electrical', rating: 4.6, reviews: 15, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, isFeatured: true },
  { name: 'Electric cable', price: 3000, images: ['/electric cable.png'], description: 'High-quality electric wiring cable.', longDescription: 'High-quality and durable electric wiring cable, available in various gauges for your needs.', category: 'lighting-electrical', rating: 4.9, reviews: 50, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, colors: ['Black', 'Red', 'Blue', 'Green'], isFeatured: true },
  { name: 'Warm light wall bracket', price: 1900, images: ['/Warm light wall bracket.png'], description: 'An elegant warm light wall bracket.', longDescription: 'An elegant warm light wall bracket that provides a cozy and inviting ambiance.', category: 'lighting-electrical', rating: 4.5, reviews: 22, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, colors: ['Silver'], isFeatured: true },
  { name: 'PPR Pipe Fittings', price: 30, images: ['/PPR Pipe Fittings.png'], description: 'A set of durable PPR pipe fittings.', longDescription: 'A complete set of durable PPR pipe fittings for all your plumbing projects.', category: 'plumbing', rating: 5, reviews: 110, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, isFeatured: true },
  ...
  { name: 'Plumbing Pipe', price: 2000, images: ['/ppr pipes.png'], description: 'High-quality plumbing pipes.', longDescription: 'Durable and reliable plumbing pipes suitable for a variety of residential and commercial applications. Available in multiple sizes.', category: 'plumbing', rating: 4.8, reviews: 80, seller: { name: 'Alpha Electricals', id: 'seller-alpha' } },
  ...
  { name: 'soap dish', price: 500, images: ['/soap dish.png'], description: 'A simple and elegant soap dish.', longDescription: 'A clean and minimalist soap dish that keeps your soap dry and your sink area tidy.', category: 'plumbing', rating: 4.5, reviews: 180, seller: { name: 'Alpha Electricals', id: 'seller-alpha' } },
  ...
  { name: 'oval toilet', price: 29000, images: ['/oval toilet.jpg'], description: 'A classic and comfortable oval toilet.', longDescription: 'A classic oval toilet that combines timeless design with modern water-saving technology.', category: 'plumbing', rating: 4.8, reviews: 50, seller: { name: 'Alpha Electricals', id: 'seller-alpha' } },
