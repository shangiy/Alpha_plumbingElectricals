...
export const allProductsData: Omit<Product, 'id'>[] = [
  ...
  { name: 'Ample Light', price: 2500, images: ['/ample-light-product.jpg'], description: 'A beautiful and bright ample light.', longDescription: 'A beautiful and bright ample light, perfect for any room in your house.', category: 'lighting-electrical', rating: 4.5, reviews: 10, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: 'ALPHA-ELEC-001', colors: ['White', 'Silver'], isFeatured: true, unit: 'item' },
  ...
  { name: 'Masai Cable Flex 4.0mm', price: 375, images: ['/masai cable Flex cable.png'], description: '4.0mm Masai flex cable.', longDescription: 'High-quality 4.0mm flex cable from Masai for various electrical applications.', category: 'lighting-electrical', rating: 4.9, reviews: 150, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, unit: 'meter' },
  ...
  { name: 'PPR Male Adaptor 50mm*1/2', price: 280, images: ['https://picsum.photos/seed/ppr-adaptor/400/400'], description: 'A durable PPR male adaptor for 50mm pipes.', longDescription: 'A high-quality PPR male adaptor for connecting 50mm pipes to 1/2 inch threaded fittings. Ensures a secure, leak-proof connection in plumbing systems.', category: 'plumbing', rating: 4.8, reviews: 120, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: 'PPR-MA-50', isFeatured: false, unit: 'item' },
  { name: 'Full Bora 4" Toilet Cistern', price: 3000, images: ['https://picsum.photos/seed/toilet-cistern/400/400'], description: 'A complete 4" toilet cistern mechanism.', longDescription: 'A complete "Full Bora" 4-inch toilet cistern internal mechanism. Includes flush valve and fill valve for a full replacement or upgrade.', category: 'plumbing', rating: 4.7, reviews: 95, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: 'FB-CIST-4', isFeatured: false, unit: 'item' },
  { name: '3W Maxtek LED Panel Blue', price: 145, images: ['https://picsum.photos/seed/led-panel/400/400'], description: 'A 3W blue LED panel light by Maxtek.', longDescription: 'An energy-efficient 3W Maxtek LED panel with a vibrant blue light output. Perfect for decorative or ambient lighting applications.', category: 'lighting-electrical', rating: 4.6, reviews: 88, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '16464', isFeatured: false, unit: 'item' },
  { name: '4ft 25W Vellmax Tube', price: 320, images: ['https://picsum.photos/seed/fluorescent-tube/400/400'], description: 'A 4-foot 25W Vellmax tube light.', longDescription: 'A high-quality 4-foot, 25-watt Vellmax tube light. Provides bright and reliable illumination for garages, workshops, and commercial spaces.', category: 'lighting-electrical', rating: 4.7, reviews: 150, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '16468', isFeatured: false, unit: 'item' },
  { name: 'KS1010 4-Way Concealed Consumer Unit', price: 11640, images: ['https://picsum.photos/seed/consumer-unit/400/400'], description: 'A 4-way concealed consumer unit.', longDescription: 'The KS1010 is a 4-way consumer unit designed for concealed installation, providing a neat and safe solution for residential circuit protection.', category: 'lighting-electrical', rating: 4.9, reviews: 60, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '2186484', isFeatured: false, unit: 'item' },
  { name: '4.0mm Masai Flex Cable', price: 360, images: ['https://picsum.photos/seed/flex-cable/400/400'], description: 'A flexible 4.0mm electrical cable from Masai.', longDescription: 'High-quality and flexible 4.0mm electrical flex cable from Masai. Ideal for a variety of wiring applications. Price is per meter.', category: 'lighting-electrical', rating: 4.8, reviews: 210, seller: { name: 'Alpha Electricals', id: 'seller-alpha' }, barcode: '16248', isFeatured: false, unit: 'meter' },
];
